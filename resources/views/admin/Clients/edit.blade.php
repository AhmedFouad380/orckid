        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <form id="kt_account_profile_details_form" action="{{url('update-Clients')}}" class="form"
                          method="post">
                    @csrf
                    <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2"> {{__('lang.note')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <textarea class="form-control" rows="5" name="note">{{$employee->note}}</textarea>
                                <!--end::Input-->
                                <span id="error-validation" style="color:red"></span>
                            </div>
                            <!--end::Input group-->
