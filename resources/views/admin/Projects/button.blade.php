        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form enctype="multipart/form-data" id="" class="form" method="post" action="{{url('store-Projects')}}">
                    @csrf
                    <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <textarea name="ar_description" class="form-control" rows="5"></textarea>
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <textarea name="en_description" class="form-control" rows="5"></textarea>
                                <!--end::Input-->
                            </div>
