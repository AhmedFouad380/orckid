        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="" class="form" method="post" action="{{url('store-Messages')}}">
                    @csrf
                    <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select name="client_id[]" multiple class="js-example-basic-single form-control">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <textarea class="form-control" name="message" id="editor1"></textarea>
                                <!--begin::Input-->
                                <!--end::Input-->
                            </div>
