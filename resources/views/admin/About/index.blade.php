    ...
    <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
        ...
        <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                <!--begin::Heading-->
                <h1 class="text-dark fw-bolder my-0 fs-2">{{__('lang.About')}} </h1>
                <!--end::Heading-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">{{__('lang.About')}}</li>
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">{{__('lang.About')}}</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <form enctype="multipart/form-data" id="kt_account_profile_details_form" action="{{url('update-About')}}" class="form"
                          method="post">
                    @csrf
                    <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <textarea name="ar_description" class="form-control" rows="5">{{$employee->ar_description}}</textarea>
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <textarea name="en_description" class="form-control" rows="5">{{$employee->en_description}}</textarea>
                                <!--end::Input-->
                            </div>
